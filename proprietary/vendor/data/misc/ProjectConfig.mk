...
CUSTOM_HAL_IMGSENSOR = imx179_mipi_raw_5mp ov5670_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = imx179_mipi_raw_5mp ov5670_mipi_raw
...
CUSTOM_MODEM = t939w_band1_band2_band8_co_gps
...
############################### TEKSUN BEGIN#####################################
TEKSUN_DRIVE_COMMON_BOARD_DWS_NAME = T939W_V1
XUNHU_PROJECT_MEMORY_TYPE=8.2die.ddr3.Discrete
XUNHU_LPS_TEKHW_SUPPORT=yes
MTK_BUILD_VERNO=T939_V2_F06SF_oneclick_v012
BUILD_GMS=yes
XUNHU_QTY_SMART_WAKE_UP=yes
XUNHU_RECENTS_APP_LOCK=yes
XUNHU_FLIP_MUTE=yes
XUNHU_AUTO_CLEAN_BACKGROUND_MEMORY=yes
# 功能：关机动画自定义
XUNHU_SHUTDOWN_ANIMATION=CUST
XUNHU_ZJJ_PRELOADMEDIA=yes
XUNHU_ADJUST_CODE_FOR_DEFAULT_VALUE_SET=yes
XUNHU_STREAM_VOICE_CALL=7
XUNHU_STREAM_SYSTEM=15
XUNHU_STREAM_RING=15
XUNHU_STREAM_MUSIC=15
XUNHU_STREAM_ALARM=15
XUNHU_STREAM_NOTIFICATION=15
#XUNHU_SUPPRORT_EMERGENCY_RESCUE=yes
#XUNHU_SMALL_SCREEN_MODE=yes
XUNHU_ADD_RAM_ROM_SHOW=yes
XUNHU_SETTING_RAM_VALUE=1
XUNHU_SETTING_ROM_VALUE=8
#功能:重启完整播放完关机动画 yes:打开　no:关闭，默认no
XUNHU_REBOOT_DELAY_ANIMATION=yes
#统一设置型号、MTP、PTP、WIFI AP、USB、BT和磁盘名称
XUNHU_MODEL=X1
# 设置品牌名称，可以带空格
XUNHU_BRAND=OneClick
#设置设备名称，设备名称不能带空格
XUNHU_DEVICE=X1
...
#功能:设置背光亮的延迟时间
XUNHU_WBJ_RESUME_BACKLIGHT_DELAY_TIME=100
...
#功能:客制化虚拟按键
#使用方法:yes/no,默认no
XUNHU_CUSTOM_NAVIGATIONBAR=yes
#功能:相机设置中显示对焦声音菜单
...
#功能:信号强度调整优化
#使用方法:yes/no,默认yes
XUNHU_LYH_SIGNAL_ENHANCEMENT=yes
#功能:美颜拍照保存方式
#使用方法:yes/no,默认no，yes:美颜拍照只保存1张图片 no:美颜拍照默认保存原图与美颜后效果图
XUNHU_FACEBEAUTY_SAVE_ONLY_PHOTO=yes
#功能:手势体感功能:三指截屏、双指调节音量、双击灭屏、长按back自由截屏
#使用方法:yes/no,默认no
...
#作者:TRF1201
#功能:LAUNCHERL界面navigation bar icon & status bar icon is white
#使用方法:yes/no,默认no，yes:桌面navigation bar icon和状态栏icon为白色
XUNHU_LAUNCHER_NAV_STATUS_ISLIGHT=yes
TRUSTKERNEL_TEE_DYNAMIC_MACTH_SUPPORT = yes
#功能:tp不支持三点触控,去掉手势体感中的三指功能
#使用方法:yes/no,默认no
...
TEKSUN_HARDWARE_CAMERA_SUPPORT = sp2609_mipi_raw_front hi556_mipi_raw sp2609_mipi_raw hi556_mipi_raw_sub
#功能:power+音量上键录屏功能
#使用方法:yes/no,默认no
XUNHU_LIUT_VOLUMEUP_POWER_SCREENRECORDER=yes
############################### TEKSUN END#####################################
